...
(function () {
  if (typeof document !== 'undefined') {
    var head = document.head || document.getElementsByTagName('head')[0],
        ...
        css = ".vueperslide { white-space: normal; background-size: cover; display: inline-block; position: relative; width: 100%; height: 100%; } .vueperslide__image { position: absolute; top: 0; left: 0; right: 0; bottom: 0; background-size: cover; } .vueperslide__content-wrapper:not(.vueperslide__content-wrapper--outside-top):not(.vueperslide__content-wrapper--outside-bottom) { position: absolute; } .vueperslides--fade .vueperslide { position: absolute; top: 0; left: 0; right: 0; bottom: 0; opacity: 0; -webkit-transition: .8s ease-in-out opacity; -o-transition: .8s ease-in-out opacity; transition: .8s ease-in-out opacity; } .vueperslides--fade .vueperslide--active { z-index: 1; opacity: 1; } ";style.type = 'text/css';if (style.styleSheet) {
...
var VueperSlide = { render: function render() {
  ...
  computed: {
    wrapperStyles: function wrapperStyles() {
      return _extends$1({}, !this.$parent.conf.slideImageInside && this.image && { backgroundImage: 'url(' + this.image + ')' });
    },
