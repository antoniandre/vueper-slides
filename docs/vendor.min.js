...
/*!***************************************!*\
  ...
  \***************************************/
/*! exports provided: VCard, VCardMedia, VCardTitle, VCardActions, VCardText, default */function(t,e,n){"use strict";n.r(e),n.d(e,"VCardActions",function(){return a}),n.d(e,"VCardText",function(){return l});var i=n(/*! ../../util/helpers */"./src/util/helpers.ts"),s=n(/*! ./VCard */"./src/components/VCard/VCard.js");n.d(e,"VCard",function(){return s.default});var r=n(/*! ./VCardMedia */"./src/components/VCard/VCardMedia.js");n.d(e,"VCardMedia",function(){return r.default});var o=n(/*! ./VCardTitle */"./src/components/VCard/VCardTitle.js");n.d(e,"VCardTitle",function(){return o.default});var a=Object(i.createSimpleFunctional)("v-card__actions"),l=Object(i.createSimpleFunctional)("v-card__text");s.default.install=function(t){t.component(s.default.name,s.default),t.component(r.default.name,r.default),t.component(o.default.name,o.default),t.component(a.name,a),t.component(l.name,l)},e.default=s.default},"./src/components/VCarousel/VCarousel.js":
/*!***********************************************!*\
...
/*!*****************************************!*\
  ...
  \*****************************************/
/*! exports provided: checkVueVersion, default */function(t,e,n){"use strict";n.r(e),n.d(e,"checkVueVersion",function(){return h});var i=n(/*! ./mixins/application */"./src/components/Vuetify/mixins/application.js"),s=n(/*! ./mixins/theme */"./src/components/Vuetify/mixins/theme.ts"),r=n(/*! ./mixins/icons */"./src/components/Vuetify/mixins/icons.js"),o=n(/*! ./mixins/options */"./src/components/Vuetify/mixins/options.js"),a=n(/*! ./mixins/lang */"./src/components/Vuetify/mixins/lang.ts"),l=n(/*! ../../util/console */"./src/util/console.ts"),c=n(/*! ./util/goTo */"./src/components/Vuetify/util/goTo.js"),u={install:function(t,e){if(void 0===e&&(e={}),!this.installed){this.installed=!0,h(t);var n=Object(a.default)(e.lang);t.prototype.$vuetify=new t({data:{application:i.default,breakpoint:{},dark:!1,icons:Object(r.default)(e.iconfont,e.icons),lang:n,options:Object(o.default)(e.options),rtl:e.rtl,theme:Object(s.default)(e.theme)},methods:{goTo:c.default,t:n.t.bind(n)}}),e.transitions&&Object.values(e.transitions).forEach(function(e){void 0!==e.name&&e.name.startsWith("v-")&&t.component(e.name,e)}),e.directives&&Object.values(e.directives).forEach(function(e){t.directive(e.name,e)}),e.components&&Object.values(e.components).forEach(function(e){t.use(e)})}},version:"1.1.1"};function h(t,e){var n=e||"^2.5.10",i=n.split(".",3).map(function(t){return t.replace(/\D/g,"")}).map(Number),s=t.version.split(".",3).map(function(t){return parseInt(t,10)});s[0]===i[0]&&(s[1]>i[1]||s[1]===i[1]&&s[2]>=i[2])||Object(l.consoleWarn)("Vuetify requires Vue version "+n)}e.default=u},"./src/components/Vuetify/mixins/application.js":
/*!******************************************************!*\
